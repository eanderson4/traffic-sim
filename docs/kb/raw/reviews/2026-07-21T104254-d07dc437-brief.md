...
The exact staged diff is at /tmp/external-review-dhLCUm/diff.patch (stat: /tmp/external-review-dhLCUm/diffstat.txt).
...
End your review with a line containing exactly: REVIEW-COMPLETE
